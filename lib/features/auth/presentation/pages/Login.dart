  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<BiometricCubit, BiometricState>(
        ...
        child: BlocListener<LoginCubit, login_state>(
          listener: (context, state) {
                    ...
                    actions: [
                      TextButton(
                        onPressed: () async {
                          ...
                          // UPDATE SWITCH IMMEDIATELY
                          context.read<FingerprintCubit>().setEnabled(
                            uid,
                            false,
                          );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BlocBuilder<LoginCubit, login_state>(
                    builder: (context, state) {
                      final cubit = context.read<LoginCubit>();
                                ...
                                return Container(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      final email = emailController.text.trim();
                                      final uid =
                                          await LocalStorage.getUidByEmail(
                                            email,
                                          );
